...
from app.routers.leaderboard import router as leaderboards_router
from app.routers.penalty import router as penalties_router
...
app.include_router(leaderboards_router, prefix=settings.API_STR)
app.include_router(penalties_router, prefix=settings.API_STR)
app.include_router(scores_router, prefix=settings.API_STR)
